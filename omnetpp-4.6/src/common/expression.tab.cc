...
#line 1775 "expression.tab.cc"
    break;

  case 46:
#line 268 "expression.y"
                { yyval = expryyconcat(yyvsp[-2],yyvsp[-1],yyvsp[0]); }
#line 1781 "expression.tab.cc"
    break;

  case 47:
#line 270 "expression.y"
                { yyval = expryyconcat(yyvsp[-2],yyvsp[-1],yyvsp[0]); }
#line 1787 "expression.tab.cc"
    break;

  case 48:
#line 272 "expression.y"
                { yyval = expryyconcat(yyvsp[-1],yyvsp[0]); }
#line 1793 "expression.tab.cc"
    break;

  case 49:
#line 274 "expression.y"
                { yyval = expryyconcat(yyvsp[-1],yyvsp[0]); }
#line 1799 "expression.tab.cc"
    break;


#line 1803 "expression.tab.cc"
