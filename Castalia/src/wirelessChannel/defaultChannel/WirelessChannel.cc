...
void WirelessChannel::initialize(int stage)
{
	...
	for (int i = 0; i < numOfSpaceCells; i++) {
		...
		for (int j = i + 1; j < numOfSpaceCells; j++) {
			...
			nodeDistance[i][j] = dist;			
			if (dist > distanceThreshold)
				continue;

			/* if the distance is very small (arbitrarily: smaller than one hunderedth
...
void WirelessChannel::handleMessage(cMessage * msg)
{
	...
	case WC_SIGNAL_START:{
			...
			for (it1 = pathLoss[cellTx].begin(); it1 != pathLoss[cellTx].end(); it1++) {
				...
				for (it2 = cellOccupation[(*it1)->cellID].begin();
					...
					///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
					sendDelayed(signalMsgCopy,nodeDistance[min(srcAddr,*it2)][max(srcAddr,*it2)]/300000000 + (rand()%100) / 1000000, "toNode", *it2);
					///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	case WC_SIGNAL_END:{
			...
			for (it1 = nodesAffectedByTransmitter[srcAddr].begin();
				...
				////////////////////////////////////////////////////////////////////////////////////////////////////////////
				sendDelayed(signalMsgCopy, nodeDistance[min(srcAddr,*it1)][max(srcAddr,*it1)]/300000000,"toNode", *it1);
				////////////////////////////////////////////////////////////////////////////////////////////////////////////
			}	//for it1
